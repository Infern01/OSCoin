...
sconst int64 MAX_MONEY = 8000000000000 * COIN; // 8 trillion maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 10000; // 1440 blocks found a day. Priority cutoff is 1 BAR day / 10000 bytes.
    }
